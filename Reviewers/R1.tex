...
\begin{revresponse}
	...
	(1) In the online problem, each sensor has a control communication range, which is broader than data transmission range.% and is used to send sensor information to the UAV. 
	...
	(2) There is a proportional relationship between the radius of the data transmission range and the control communication range. %, which is primarily determined by the sensor's transmission power.
