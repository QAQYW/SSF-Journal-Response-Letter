...
\end{revcomment}
\begin{revresponse}
	We appreciate the reviewer's comment on the dynamics of sensors, which highlights important aspects that could influence the effectiveness the UAV schedule.
	...
	However, the inaccurate sensor localization leads to discrepancies between the UAV's schedule and actual environment.
	...
	Regardless of whether reconnection is successful, the schedule will be re-planned to ensure energy efficiency.
